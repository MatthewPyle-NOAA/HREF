...
pqpf_1h_thresh = [0.01,0.25,0.5]
pqpf_3h_thresh = [0.01,0.25,0.5]
pqpf_6h_thresh = [0.01,0.25,0.5,1.0]
pqpf_12h_thresh = [0.25,0.5,1.0,2.0]
pqpf_24h_thresh = [0.25,0.5,1.0,2.0,3.0]
